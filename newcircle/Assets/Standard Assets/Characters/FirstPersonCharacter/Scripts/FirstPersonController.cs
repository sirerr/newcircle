...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
		...
		[SerializeField] private float m_lookspeed = 0;
        ...
        private void RotateView()
        {
			...
			Vector2 mouseInput = m_MouseLook.clampVerticalRotation(m_YRotation,transform.localEulerAngles.y);

			//testcode
			 

			m_Camera.transform.localEulerAngles = new Vector3(-mouseInput.y,m_Camera.transform.localEulerAngles.y,m_Camera.transform.localEulerAngles.z);
			...
			print(CrossPlatformInputManager.GetAxisRaw("VerticalLook"));
